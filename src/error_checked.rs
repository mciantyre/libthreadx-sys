...
//! Error-checked ThreadX services.
//!
//! You should use these ThreadX services unless you have a good reason to use
//! the `unchecked` variants.
//!
//! These functions link against their `_txe_*` counterparts. If you're a C user
//! and you *do not* define `TX_DISABLE_ERROR_CHECKING`, then these are the
...
pub unsafe extern "C" fn tx_block_pool_create(
    ...
    _txe_block_pool_create(
        ...
        pool_start,
        pool_size,
        core::mem::size_of::<TX_BLOCK_POOL>() as _,
    )
}
...
pub unsafe extern "C" fn tx_byte_pool_create(
    ...
    _txe_byte_pool_create(
        ...
        pool_start,
        pool_size,
        core::mem::size_of::<TX_BYTE_POOL>() as _,
    )
}
...
unsafe extern "C" {
    ...
    #[link_name = "_txe_event_flags_info_get"]
    ...
    #[link_name = "_txe_event_flags_set"]
    ...
    #[link_name = "_txe_event_flags_set_notify"]
...
#[inline(always)]
pub unsafe extern "C" fn tx_event_flags_create(
    group_ptr: *mut TX_EVENT_FLAGS_GROUP,
    name_ptr: *mut CHAR,
) -> UINT {
    unsafe extern "C" {
        fn _txe_event_flags_create(
            group_ptr: *mut TX_EVENT_FLAGS_GROUP,
            name_ptr: *mut CHAR,
    ...
    _txe_event_flags_create(
        group_ptr,
        name_ptr,
        core::mem::size_of::<TX_EVENT_FLAGS_GROUP>() as _,
    )
}
...
pub unsafe extern "C" fn tx_mutex_create(
    ...
    _txe_mutex_create(
        ...
        name_ptr,
        inherit,
        core::mem::size_of::<TX_MUTEX>() as _,
    )
}
...
unsafe extern "C" {
    ...
    #[link_name = "_txe_queue_send_notify"]
    ...
    #[link_name = "_txe_queue_front_send"]
...
#[inline(always)]
pub unsafe extern "C" fn tx_queue_create(
    queue_ptr: *mut TX_QUEUE,
    name_ptr: *mut CHAR,
    message_size: UINT,
    ...
    _txe_queue_create(
        ...
        queue_start,
        queue_size,
        core::mem::size_of::<TX_QUEUE>() as _,
    )
}
...
unsafe extern "C" {
    ...
    #[link_name = "_txe_semaphore_ceiling_put"]
    ...
    #[link_name = "_txe_semaphore_info_get"]
...
#[inline(always)]
pub unsafe extern "C" fn tx_semaphore_create(
    semaphore_ptr: *mut TX_SEMAPHORE,
    name_ptr: *mut CHAR,
    initial_count: ULONG,
) -> UINT {
    unsafe extern "C" {
        fn _txe_semaphore_create(
            semaphore_ptr: *mut TX_SEMAPHORE,
            name_ptr: *mut CHAR,
            initial_count: ULONG,
    ...
    _txe_semaphore_create(
        ...
        name_ptr,
        initial_count,
        core::mem::size_of::<TX_SEMAPHORE>() as _,
    )
}
...
unsafe extern "C" {
    ...
    #[link_name = "_txe_thread_info_get"]
    ...
    #[link_name = "_txe_thread_preemption_change"]
    ...
    #[link_name = "_txe_thread_priority_change"]
...
pub unsafe extern "C" fn tx_thread_create(
    ...
    _txe_thread_create(
        ...
        time_slice,
        auto_start,
        core::mem::size_of::<TX_THREAD>() as _,
    )
}
...
#[inline(always)]
pub unsafe extern "C" fn tx_timer_create(
    timer_ptr: *mut TX_TIMER,
    name_ptr: *mut CHAR,
    ...
    _txe_timer_create(
        ...
        reschedule_ticks,
        auto_activate,
        core::mem::size_of::<TX_TIMER>() as _,
    )
}
